...
public class VolumeUnitConverter 
{
   ...
   */
  public static double convert(final double value, final MassVolumeConverter.Unit 
      from, final MassVolumeConverter.Unit to) 
  {
   ...
   */
  public static double toFluidOunce(final double value, final MassVolumeConverter.Unit from)
  {
    switch (from) 
    {
   ...
   * @throws IllegalArgumentException if the unit is not supported
   */
  public static double fromFluidOunce(final double value, final MassVolumeConverter.Unit to) 
  {
    switch (to) 
    {
      case PINCHES: return ((value * 16.0) * 3.0) * 2.0;
